...
public class clsFurniture extends clskoneksi{
    ...
    String StokFurniture;
    public void TampilData()
    {
        sql="select * from furniture";
    }
    public void Baru(String fid_furniture,String fnama_furniture,String fharga_furniture, String fstok)
    {
        try
        {
            fid_furniture="";
...
//             
   ...
   public void simpan() {
    ...
    public void Edit() {
    try {
        sql = "UPDATE furniture SET nama_furniture = '" + NamaFurniture + "', harga = '"+ HargaFurniture+"', stok = '"+StokFurniture+"' WHERE id_furniture = '" + IDFurniture + "'";
    } catch (Exception e) {
        JOptionPane.showMessageDialog(null, "Terjadi Kesalahan");
        System.out.println(e.getMessage());
    }
